...
/**
 * This class computes the xth quantile over a time window of events
 */
public class Query3_RichWindowFunction extends RichWindowFunction<PSM_ClickEvent, Tuple4<Long, String, Double, Long>, Tuple, TimeWindow> {
    ...
    public void open(Configuration parameters) throws Exception {
        getRuntimeContext()
                .getMetricGroup()
                .gauge("Query3.OverallLatency", new Gauge<Long>() {
                    @Override
        ...
        getRuntimeContext()
                .getMetricGroup()
                .gauge("Query3_RichWindowFunction.Latency", new Gauge<Long>() {
                    @Override
                    public Long getValue() {
                        return latency;
                    }
        ...
        getRuntimeContext()
                .getMetricGroup()
                .gauge("Query3_RichWindowFunction.WaitingTime", new Gauge<Long>() {
                    @Override
                    public Long getValue() {
                        return waitingTime;
                    }
        ...
        this.meter = getRuntimeContext()
                .getMetricGroup()
                .meter("Query3_RichWindowFunction.Throughput", new DropwizardMeterWrapper(meter));
        super.open(parameters);

    }

    @Override
    public void apply(Tuple tuple, TimeWindow timeWindow, Iterable<PSM_ClickEvent> clicks, Collector<Tuple4<Long, String, Double, Long>> collector) {
        ...
        String key = clicks.iterator().next().getOwner();
